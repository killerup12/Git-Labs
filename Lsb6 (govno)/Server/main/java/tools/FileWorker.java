...
public class FileWorker {
    ...
    public static boolean isReachable(File file) {
        ...
        if (!file.exists()) {
            logger.error("Could not find the file \"" + file.getName() + "\"");
            success = false;
        } else if (!file.canRead()) {
            logger.error("Could not open the file \"" + file.getName() + "\" for read!");
            success = false;
        } else if (!file.canWrite()) {
            logger.error("Could not open the file \"" + file.getName() + "\" for write!");
            success = false;
        }
        return success;
    }
    ...
    public static File enterFile(String thePathToTheFile) {
        ...
        if (thePathToTheFile != null) {
            ...
            logger.error("The path to file is null!");
